...
namespace CSharp.ZipLib.Zip
{
    ...
    public class ZipEntryFactory : IEntryFactory
    {
        ...
        {
            ZipEntry _result = new ZipEntry(nameTransform_.TransformFile(fileName));
            _result.IsUnicodeText = isUnicodeText_;
            ...
            if ((fi != null) && fi.Exists)
            {
                switch (timeSetting_)
                {
                    case TimeSetting.CreateTime:
                        _result.DateTime = fi.CreationTime;
                        break;
...
#else
                        _result.DateTime = fi.CreationTimeUtc;
#endif
                        break;

                    case TimeSetting.LastAccessTime:
                        _result.DateTime = fi.LastAccessTime;
                        break;
...
#else
                        _result.DateTime = fi.LastAccessTimeUtc;
#endif
                        break;

                    case TimeSetting.LastWriteTime:
                        _result.DateTime = fi.LastWriteTime;
                        break;
...
#else
                        _result.DateTime = fi.LastWriteTimeUtc;
#endif
                        break;

                    case TimeSetting.Fixed:
                        _result.DateTime = fixedDateTime_;
                        break;
            ...
            if (useAttributes)
            {
                ...
                _result.ExternalFileAttributes = externalAttributes;
            }
