...
namespace Oraion.CSharp.ZipLib.Zip
{
    ...
    public class ZipOutputStream : DeflaterOutputStream
    {
        ...
        private void WriteLeShort(int value)
        {
            unchecked
            {
                m_baseOutputStream.WriteByte((byte)(value & 0xff));
                m_baseOutputStream.WriteByte((byte)((value >> 8) & 0xff));
            }
        }
        ...
        public void PutNextEntry(ZipEntry entry)
        {
            ...
            CompressionMethod _method = entry.CompressionMethod;
            int _compressionLevel = defaultCompressionLevel;
            ...
            if (entry.Size == 0)
            {
                ...
                entry.Crc = 0;
                _method = CompressionMethod.Stored;
            ...
            else
            {
                ...
                if (_method == CompressionMethod.Stored)
                {
            ...
            entry.Offset = offset;
            entry.CompressionMethod = (CompressionMethod)_method;

            curMethod = _method;
            sizePatchPos = -1;

            if ((m_useZip64 == UseZip64.On) || ((entry.Size < 0) && (m_useZip64 == UseZip64.Dynamic)))
            {
                entry.ForceZip64();
            }
            ...
            else
            {
                ...
                {
                    crcPatchPos = m_baseOutputStream.Position;
                }
                WriteLeInt(0);	// Crc

                if (patchEntryHeader)
                {
                    sizePatchPos = m_baseOutputStream.Position;
                }
            ...
            if (name.Length > 0)
            {
                m_baseOutputStream.Write(name, 0, name.Length);
            }
            ...
            if (extra.Length > 0)
            {
                m_baseOutputStream.Write(extra, 0, extra.Length);
            }
            ...
            {
                m_deflater.Reset();
                m_deflater.SetLevel(_compressionLevel);
            }
            size = 0;
        ...
        public void CloseEntry()
        {
            ...
            if (patchEntryHeader == true)
            {
                ...
                long curPos = m_baseOutputStream.Position;
                m_baseOutputStream.Seek(crcPatchPos, SeekOrigin.Begin);
                ...
                if (curEntry.LocalHeaderRequiresZip64)
                {
                    ...
                    m_baseOutputStream.Seek(sizePatchPos, SeekOrigin.Begin);
                ...
                m_baseOutputStream.Seek(curPos, SeekOrigin.Begin);
            }
        ...
        void WriteEncryptionHeader(long crcValue)
        {
            ...
            m_baseOutputStream.Write(cryptBuffer, 0, cryptBuffer.Length);
        }
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            switch (curMethod)
            {
                ...
                case CompressionMethod.Stored:
                    ...
                    {
                        m_baseOutputStream.Write(buffer, offset, count);
                    }
                    break;
            }
        }
        ...
        void CopyAndEncrypt(byte[] buffer, int offset, int count)
        {
            ...
            while (count > 0)
            {
                ...
                m_baseOutputStream.Write(localBuffer, 0, bufferCount);
                count -= bufferCount;
                offset += bufferCount;
            }
        }
        ...
        public override void Finish()
        {
            ...
            foreach (ZipEntry entry in entries)
            {
                ...
                {
                    m_baseOutputStream.Write(entryComment, 0, entryComment.Length);
                }

                sizeEntries += ZipConstants.CentralHeaderBaseSize + name.Length + extra.Length + entryComment.Length;
            }

            using (ZipHelperStream zhs = new ZipHelperStream(m_baseOutputStream))
            {
        ...
        UseZip64 m_useZip64 = UseZip64.Dynamic;
        #endregion
    }
}